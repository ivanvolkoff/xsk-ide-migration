...
migrationLaunchView.controller("NeoCredentialsViewController", [
    ...
    function ($scope, migrationDataState) {
        ...
        $scope.regions = [
            {
                name: "Australia (Sydney) | ap1.hana.ondemand.com",
                region: "ap1.hana.ondemand.com",
            },
            {
                name: "Europe (Rot) | eu1.hana.ondemand.com",
                region: "eu1.hana.ondemand.com",
            },
            {
                name: "Europe (Frankfurt) | eu2.hana.ondemand.com",
                region: "eu2.hana.ondemand.com",
            },
            {
                name: "Europe (Amsterdam) | eu3.hana.ondemand.com",
                region: "eu3.hana.ondemand.com",
            },
            {
                name: "Japan (Tokyo) | jp1.hana.ondemand.com",
                region: "jp1.hana.ondemand.com",
            },
            {
                name: "US East (Ashburn) | us1.hana.ondemand.com",
                region: "us1.hana.ondemand.com",
            },
            {
                name: "US East (Sterling) | us3.hana.ondemand.com",
                region: "us3.hana.ondemand.com",
            },
        ];
        ...
        $scope.userInput = function () {
            if (
                ...
                migrationDataState.neoSubaccount &&
        ...
        $scope.filterRegions = function () {
            if ($scope.regionSearch) {
                ...
                if (!alreadyHaveUserEnteredRegion) {
                    filtered.push({
                        name: 'Use "' + $scope.regionSearch + '" as a region',
                        region: $scope.regionSearch,
                        isUserEnteredRegion: true,
                    });
                }
